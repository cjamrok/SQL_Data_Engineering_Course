...
1. [`01_top_demanded_skills.sql`](01_Query-TopDemandedSkills.sql) – demand analysis with multi-table joins  
2. [`02_top_paying_skills.sql`](02_Query-HighestPayingSkills.sql) – salary analysis with aggregations  
3. [`03_optimal_skills.sql`](03_Query-OptimalSkills.sql) – combined demand/salary optimization query  
...
1. **[Top Demanded Skills](01_Query-TopDemandedSkills.sql)** – Identifies the 10 most in-demand skills for remote data engineer positions
2. **[Top Paying Skills](02_Query-HighestPayingSkills.sql)** – Analyzes the 25 highest-paying skills with salary and demand metrics
3. **[Optimal Skills](03_Query-OptimalSkills.sql)** – Calculates an optimal score using natural log of demand combined with median salary to identify the most valuable skills to learn
...
--Testing 12345, going to change readme file here and then commit to remote repo, then pull it down to working directory locally with git pull (instead of git fetch and then git merge)
